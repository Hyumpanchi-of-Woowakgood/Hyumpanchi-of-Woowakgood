...
var random_var = percentage_k(50+((global.snowflake_amount)*100)*0.2+floor(global.wind_dir))
if random_var = 1
{
	if global.l_q_grap = 0
	{
		...
		{
		var random_cre_obj = percentage_k(40)
		}
		else
		{
		...
		if (global.playing_scene > 0 || instance_number(revive_with_rage_scene) > 0) && global.l_q_grap = 0
		{
		random_cre_obj = 2
		}
