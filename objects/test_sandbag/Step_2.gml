...
if hit_cooltime != 0
{
	if global.achievement_finish[9] = 0
	{
	a = 1
	global.achievement_finish[9] = 0.1
	}
}
...
if a > 30
{
	if global.achievement_finish[9] = 0.1
	{
	var _message = instance_create_depth(-100,-100,-9999999999,achievement)
	_message.title = "더 때려줘"
	_message.text = "샌드백 노비를 때렸다"
	global.achievement_finish[9] = 1
	}
}
