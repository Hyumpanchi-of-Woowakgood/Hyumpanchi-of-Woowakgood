...
draw_text_kl_scale(xx,yy-20,string(global.run_key),16,999,image_alpha,image_blend,1,0,font0,1/3,1/3,image_angle)

draw_sprite_ext(sprite_index,image_index,xx,yy,image_xscale,image_xscale,0,c_white,1)
draw_text_kl_scale(xx+32,yy-20,"달리기 (조작키 변경)",16,999,image_alpha,image_blend,0,-1,font0,1/3,1/3,image_angle)