...
draw_sprite_ext(sprite71,0,xx+xxx+scene_x,yy+163,1,1,0,c_white,scene_alpha)
}

draw_sprite_ext(sprite_index,1,x,y,image_xscale,image_yscale,alabong_angle,c_white,alabong_alpha)