...
if global.n_room != 0 || (global.rainy > 0 && instance_number(gyu_seong) = 0 && global.t_in_building < 1 && !audio_is_playing(it_s_over) && !audio_is_playing(nomal_ending) && global.vr_weared = 0)
{
instance_destroy()
}
